...
class Config(object):
    ...
    cityscapes_param = {'name': 'cityscapes',
                    ...
                    'eval_size': [400, 400],
                    'eval_steps': 100,
                    'eval_list': '/home/liu/ICNet-tensorflow-master/data/list/cityscapes_val_list.txt',
                    'train_list': '/home/liu/ICNet-tensorflow-master/data/list/cityscapes_train_list.txt',
                    'data_dir': '/home/liu/cityscape'}
