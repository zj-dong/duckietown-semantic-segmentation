...
class CoordinationClearanceETHZ17 {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CoordinationClearanceETHZ17(null);
  ...
  static datatype() {
    ...
    return 'duckietown_msgs/CoordinationClearanceETHZ17';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CoordinationClearanceETHZ17(null);
...
CoordinationClearanceETHZ17.Constants = {
  NA: -1,
  WAIT: 0,
  GO: 1,
}

module.exports = CoordinationClearanceETHZ17;
