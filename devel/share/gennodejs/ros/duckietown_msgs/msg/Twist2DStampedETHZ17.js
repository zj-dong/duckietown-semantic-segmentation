...
class Twist2DStampedETHZ17 {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Twist2DStampedETHZ17(null);
  ...
  static datatype() {
    ...
    return 'duckietown_msgs/Twist2DStampedETHZ17';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Twist2DStampedETHZ17(null);
...
module.exports = Twist2DStampedETHZ17;
