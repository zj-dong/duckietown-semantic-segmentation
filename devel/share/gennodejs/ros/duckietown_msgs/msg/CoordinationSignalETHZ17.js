...
class CoordinationSignalETHZ17 {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CoordinationSignalETHZ17(null);
  ...
  static datatype() {
    ...
    return 'duckietown_msgs/CoordinationSignalETHZ17';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'e51b70c303b747aba0b9c364cf9d88b1';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CoordinationSignalETHZ17(null);
...
CoordinationSignalETHZ17.Constants = {
  OFF: 'light_off',
  ON: 'traffic_light_go',
...
module.exports = CoordinationSignalETHZ17;
