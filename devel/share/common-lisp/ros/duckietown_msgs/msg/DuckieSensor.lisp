...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DuckieSensor>)))
  ...
  (cl:format cl:nil "# Sensors send value and type messages~%# For analog sensors value = 0..4095 and fvalue = 0.0..1.0~%# For digital sensors value= 0..1 and fvalue = 0.0~%uint16 value~%float32 fvalue~%bool is_analog~%string name~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DuckieSensor)))
  "Returns full string definition for message of type 'DuckieSensor"
  (cl:format cl:nil "# Sensors send value and type messages~%# For analog sensors value = 0..4095 and fvalue = 0.0..1.0~%# For digital sensors value= 0..1 and fvalue = 0.0~%uint16 value~%float32 fvalue~%bool is_analog~%string name~%~%~%"))
