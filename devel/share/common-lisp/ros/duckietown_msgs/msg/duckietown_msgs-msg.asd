...
(defsystem "duckietown_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "BoolStampedETHZ17" :depends-on ("_package_BoolStampedETHZ17"))
    (:file "_package_BoolStampedETHZ17" :depends-on ("_package"))
    ...
    (:file "CoordinationClearanceETHZ17" :depends-on ("_package_CoordinationClearanceETHZ17"))
    (:file "_package_CoordinationClearanceETHZ17" :depends-on ("_package"))
    (:file "CoordinationSignal" :depends-on ("_package_CoordinationSignal"))
    (:file "_package_CoordinationSignal" :depends-on ("_package"))
    (:file "CoordinationSignalETHZ17" :depends-on ("_package_CoordinationSignalETHZ17"))
    (:file "_package_CoordinationSignalETHZ17" :depends-on ("_package"))
    ...
    (:file "Twist2DStampedETHZ17" :depends-on ("_package_Twist2DStampedETHZ17"))
    (:file "_package_Twist2DStampedETHZ17" :depends-on ("_package"))
